...
export default function GraphCanvas({
  ...
  const roles = useMemo<CareerRole[]>(() => {
    ...
    return graph.nodes
      ...
      .map((node) => {
        ...
        // Safely convert matchScore from number/string
        const rawMatchScore =
          properties.matchScore;

        const parsedMatchScore =
          rawMatchScore !== undefined &&
          rawMatchScore !== null &&
          rawMatchScore !== ""
        ...
        return {
          ...
          description:
            ...
            properties.description !== null
              ...
              : undefined,
          salaryRange:
            properties.salaryRange !== undefined &&
            properties.salaryRange !== null
  ...
  const relationshipSummary = useMemo(() => {
    ...
    relationships.forEach((relationship) => {
      const type =
        relationship.type?.trim() || "CONNECTED";
  ...
  if (loading) {
    return (
      <section
        aria-label="Loading career graph"
        className="
          rounded-xl
          border
          border-border
    ...
    >
      ...
      >
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Skills and career roles connected in the
            graph.
          </p>
        </div>
      ...
      {selectedNodeId && (
        ...
        >
          <p className="text-xs text-primary">
            Node selected. Click it again to
            deselect.
          </p>
        </div>
      )}
